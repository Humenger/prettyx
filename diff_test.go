...
var diffs = []difftest{
	...
	{0, "", []string{`int != string`}},
	{0, 1, []string{`0 != 1`}},
	{S{}, new(S), []string{`prettyx.S != *prettyx.S`}},
	{"a", "b", []string{`"a" != "b"`}},
	...
	{S{}, S{A: 1, S: new(S)}, []string{`A: 0 != 1`, `S: nil != &prettyx.S{}`}},
...
func TestDiffCycle(t *testing.T) {
	...
	b2 := &I{i: 1, R: b}
	b.R = b2
	expectDiffOutput(t, a, b, []string{`R: prettyx.I{
    i:  1,
    R:  &prettyx.I{(CYCLIC REFERENCE)},
} (previously visited) != prettyx.I{
    i:  1,
    R:  &prettyx.I{
        i:  1,
        R:  &prettyx.I{(CYCLIC REFERENCE)},
	...
	expectDiffOutput(t, b, a, []string{`R: prettyx.I{
    i:  1,
    R:  &prettyx.I{
        i:  1,
        R:  &prettyx.I{(CYCLIC REFERENCE)},
